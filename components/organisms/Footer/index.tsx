							...
							<div className="row gap-sm-0">
								<div className="col-md-4 col-6 mb-lg-0 mb-25">
									...
									<ul className="list-unstyled">
										<ListFooter title="About Us" />
										<ListFooter title="Press Release" />
										<ListFooter title="Terms of Use" />
										<ListFooter title="Privacy & Policy" />
									</ul>
								</div>
								<div className="col-md-4 col-6 mb-lg-0 mb-25">
									<p className="text-lg fw-semibold color-palette-1 mb-12">Support</p>
									<ul className="list-unstyled">
										<ListFooter title="Refund Policy" />
										<ListFooter title="Unlock Rewards" />
										<ListFooter title="Live Chatting" />
									</ul>
								</div>
								<div className="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
									<p className="text-lg fw-semibold color-palette-1 mb-12">Connect</p>
									<ul className="list-unstyled">
										<ListFooter title="hi@store.gg" href="mailto: hi@store.gg" />
										<ListFooter title="team@store.gg" href="mailto: team@store.gg" />
										<ListFooter
											title="Pasific 12, Jakarta Selatan"
											href="http://maps.google.com/?q=Pasific 12,
                        Jakarta Selatan"
										/>
										<ListFooter title="021 - 1122 - 9090" href="tel: 02111229090" />
									</ul>
								</div>
							</div>
						</div>
